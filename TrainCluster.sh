...
srun python src/model_training.py --dataset-path "$WORK/MMF-Proj/images/CASIA2/CASIA2.0_revised" --workdir "$TMPDIR" --version 1 --epochs 25 --batch_size 32 # add training parameters
